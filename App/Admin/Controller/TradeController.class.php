...
class TradeController extends AdminController {
    ...
    public function trade(){
            ...
            if(!empty($user_name)){
                $where['c.user_name'] = array('like',"%".$user_name."%");
            }
        $field = "a.*,b.currency_name as b_name,c.email as email,c.user_name as user_name";
        $count      = M('Trade')
            ->alias('a')
            ->field($field)
        ...
        //给分页传参数
        setPageParameter($Page, array('type'=>$type,'currency_id'=>$currency_id,'email'=>$email,'user_name'=>$user_name));
